...
static llvm::cl::bits<PointerAnalysis::PTATY> PASelected(llvm::cl::desc("Select pointer analysis"),
		llvm::cl::values(
            ...
            clEnumValN(PointerAnalysis::TYPECLONE_WPA, "typeclone", "Sparse flow sensitive pointer analysis with type-based heap cloning"),
...
void WPAPass::runPointerAnalysis(SVFModule svfModule, u32_t kind)
{
    ...
    switch (kind) {
        ...
        case PointerAnalysis::FSSPARSE_WPA:
            ...
            break;
        case PointerAnalysis::TYPECLONE_WPA:
            _pta = new TypeClone();
            break;
